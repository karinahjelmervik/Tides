...
The Norwegian Mapping Authority, Hydrographic Service, has 22 tide gauges along the Norwegian coast. Data is available from 1992 up to the current year \cite[]{tide16}. Four of the gauges are placed in the Oslofjord  (Fig.~\ref{fig:area1}) and one close to the open boundary of the Saltfjord (Fig.~\ref{fig:area2}). In addition, tidal amplitude and phases are available at a position by Finneid in the Skjerstadfjord \cite[]{tide16}.

Current measurements are performed at a position near Filtvedt in the Oslofjord using a bottom-mounted profiling current meter from 18 September to 10 November 2014.

\begin{figure}[htb]
\centering
\includegraphics[width=0.7\textwidth]{fig_Oslofjorden_area}
...
\begin{figure}[htb]
\centering
\includegraphics[width=\textwidth]{fig_Saltstraumen_area}
\caption{The Saltstraumen is a strong current in a narrow passage between the Saltfjord and the Skjerstradfjord. The position of the tide gauge in Bod{\o} and the position in Finneid where observeration where performed previously are marked.}
\label{fig:area2}
\end{figure}
