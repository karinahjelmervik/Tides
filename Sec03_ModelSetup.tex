...
The two models have slightly different setup with regards to the external forcing that is applied; the Oslofjord model is run with all realistic forcing, wheras the Saltstraumen model is a pure tidal model. 
...
For the Saltstraumen model, we kept the values at the open boundary to the west constant, based on a one year climatology from the NorKyst800 model. No atmospheric forcing or river inputs were applied.
